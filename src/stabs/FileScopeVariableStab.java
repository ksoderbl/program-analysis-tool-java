 ...
 */
public class FileScopeVariableStab extends Stab {

    /**
     * Constructs a new file scope variable stab
     *
     ...
     */
    public FileScopeVariableStab(String string,
                                 long type, long other, long desc,
                                 Expression value) {
        super(string, type, other, desc, value);
        //Main.warn("file scope variable: " + string);
    }
}
